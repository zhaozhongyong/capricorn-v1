...
function dTree(objName) {
	...
	this.icon = {
		root : mydir + 'img/base.gif',
		folder : mydir + 'img/folder.gif',
		folderOpen : mydir + 'img/folderopen.gif',
		node : mydir + 'img/page.gif',
		empty : mydir + 'img/empty.gif',
		line : mydir + 'img/line.gif',
		join : mydir + 'img/join.gif',
		joinBottom : mydir + 'img/joinbottom.gif',
		plus : mydir + 'img/plus.gif',
		plusBottom : mydir + 'img/plusbottom.gif',
		minus : mydir + 'img/minus.gif',
		minusBottom : mydir + 'img/minusbottom.gif',
		nlPlus : mydir + 'img/nolines_plus.gif',
		nlMinus : mydir + 'img/nolines_minus.gif'
	};
